DROP TABLE T_HC_PACIENTE;
DROP TABLE T_HC_ENDERECO;
DROP TABLE T_HC_TELEFONE;
DROP TABLE T_HC_CONSULTA;
DROP TABLE T_HC_MEDICO;
DROP TABLE T_HC_LEMBRETE;
DROP TABLE T_HC_CONEXAO;
